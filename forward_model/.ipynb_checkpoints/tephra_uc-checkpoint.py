...
from math import exp, cos, sin, atan2, sqrt
from .constants import RHO_A_S, G, DEG2RAD, AIR_VISC
from .utils import get_particle_diameter, rotate_radians, ExecutionProgressBar
from .grids import (
...
class TephraUC():
    def __init__(self, config):
        ...
        # TODO: allow user to add only wind_speed, wind_direction
        # currently, the code only works with a wind file        
    ...
    def get_map(self):
        ...
        folium.CircleMarker([self.vent_location[0], self.vent_location[1]],radius=5, weight=2).add_to(map)
